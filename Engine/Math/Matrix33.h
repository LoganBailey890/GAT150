...
namespace nc
{
	struct Matrix33
	{
		float m[3][3]; // [colume][row]

		Matrix33();
		Matrix33(Vector2& colum1, Vector2& colum2);
	...
	inline Matrix33::Matrix33(Vector2& colum1, Vector2& colum2)
	{
		m[0][0] = colum1[0]; m[1][0] = colum2[0];
		m[0][1] = colum1[1]; m[1][1] = colum2[1];
	}
